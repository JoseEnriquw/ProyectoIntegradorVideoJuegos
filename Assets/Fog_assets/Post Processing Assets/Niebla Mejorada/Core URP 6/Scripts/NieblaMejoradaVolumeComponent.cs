...
{
    [VolumeComponentMenu("/Niebla Mejorada")]
    [VolumeRequiresRendererFeatures(typeof(NieblaMejorada))]
    [SupportedOnRenderPipeline(typeof(UniversalRenderPipelineAsset))]
    public sealed class NieblaMejoradaVolumeComponent : VolumeComponent, IPostProcessComponent
    {
        [Serializable]
        ...
        public NieblaMejoradaVolumeComponent()
        {
            displayName = "Niebla Mejorada";
        }
