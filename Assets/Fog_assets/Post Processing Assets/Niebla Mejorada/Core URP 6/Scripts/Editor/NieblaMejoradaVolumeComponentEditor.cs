...
{
    [CustomEditor(typeof(NieblaMejoradaVolumeComponent))]
    public class NieblaMejoradaVolumeComponentEditor : VolumeComponentEditor
    {
        // FogParameters
        ...
        {
            var o = new PropertyFetcher<NieblaMejoradaVolumeComponent>(serializedObject);
        ...
        {
            EditorGUILayout.LabelField("Main", NieblaMejoradaUtility.centeredBoldLabel);
            ...
            EditorGUILayout.LabelField("Colors", NieblaMejoradaUtility.centeredBoldLabel);
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
            ...
            EditorGUILayout.LabelField("Sun Light", NieblaMejoradaUtility.centeredBoldLabel);
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
            ...
            EditorGUILayout.LabelField("Distance Fog", NieblaMejoradaUtility.centeredBoldLabel);
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
            ...
            EditorGUILayout.LabelField("Skybox Height Fog", NieblaMejoradaUtility.centeredBoldLabel);
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
            ...
            EditorGUILayout.LabelField("Height Fog", NieblaMejoradaUtility.centeredBoldLabel);
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
            ...
            EditorGUILayout.LabelField("3D Noise", NieblaMejoradaUtility.centeredBoldLabel);
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
            ...
            EditorGUILayout.LabelField("Screen Space Multiple Scattering", NieblaMejoradaUtility.centeredBoldLabel);
            using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox))
            {
                // SSMSParameters
